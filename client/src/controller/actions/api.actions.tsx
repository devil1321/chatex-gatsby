...
export type Action = HANDLE_TOKEN | LOGIN | REGISTER | GOOGLE_AUTH | LOGOUT | IS_LOGGED | GET_ROOMS | CREATE_ROOM | UPDATE_USER | GET_USERS | GET_USER | GET_MESSAGES_FROM_ROOM | GET_LAST_ROOMS | GET_PRIVATE_MESSAGES | SEND_MESSAGE_TO_ROOM | SEND_PRIVATE_MESSAGE 